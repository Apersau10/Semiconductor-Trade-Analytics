...
# Load Excel
ExportDependency_data <- read_excel("C:/Users/User/OneDrive/Documents/Chow_research/ExportDependency2024/ExportDependency2024.xlsx", sheet = 1)
...
ggplot(export_long, aes(x = Country, y = Dependency, fill = Market)) +
  ...
  labs(
    caption = "Data Source: World Trade Map*, Vietnam data quoted from Google",
    title = "Export Dependency on the US and China in 2024",
